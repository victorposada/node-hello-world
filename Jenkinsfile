    ...
    stages {
        ...
        stage('Login to Registry') {
            steps {
                ...
                buildah bud --format=docker --label org.opencontainers.image.source=https://github.com/victorposada/node-hello-world --no-cache -t ghcr.io/victorposada/node-hello-world/web:$IMAGE_TAG .
